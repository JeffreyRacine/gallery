...
- Legacy `np` FAQ PDF: no longer hosted in the current CRAN vignette set; use the current [`np` vignettes on CRAN](https://cran.r-project.org/web/packages/np/vignettes/).
- Legacy `crs` FAQ PDF: no longer hosted in the current CRAN vignette set; use the current [`crs` vignettes on CRAN](https://cran.r-project.org/web/packages/crs/vignettes/).
