...
::: {.callout-note}
## Plot interface update in `0.70-2`

The public plotting interface was redesigned in `np` / `npRmpi` `0.70-2`.
...
If you are adapting older code, the most common translation is from `plot.errors.*` names to these newer public arguments.
:::
