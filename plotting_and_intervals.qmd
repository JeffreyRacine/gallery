...
This local page tracks the release-candidate plotting interface for the forthcoming `np` / `npRmpi` `0.70-2` submissions. It should not be pushed to the public Gallery until those APIs appear on CRAN.
