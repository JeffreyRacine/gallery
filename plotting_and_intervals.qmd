...
This local page tracks the submitted `np` / `npRmpi` `0.70-2` plotting interface. It should not be pushed to the public Gallery until those APIs are visible on CRAN.
