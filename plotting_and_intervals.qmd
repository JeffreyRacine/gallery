...
As of Friday, June 26, 2026, `npRmpi` `0.70-4` and `np` `0.70-4` are now
available on CRAN.
...
If you are adapting older code after installing the new release, the most
common translation is from `plot.errors.*` names to these newer public
arguments.
:::
