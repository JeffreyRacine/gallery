...
- [Data overlays on y/x plots](plotting_and_intervals.qmd): `plot.data.overlay = TRUE/FALSE` now controls whether the data are shown directly on y/x plots, with overlay enabled by default.
