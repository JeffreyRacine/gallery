...
- [Interactive plotting surfaces](plotting_and_intervals.qmd): `renderer = "rgl"` now supports interactive 3D rotation/zoom when `rgl` is installed, while `render_control = np_render_control(...)` manages rugs and data-overlay choices on supported routes.
