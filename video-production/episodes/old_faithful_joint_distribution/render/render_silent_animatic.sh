...
ffmpeg -hide_banner -y \
  -loop 1 -framerate 30 -t 2.85 -i "${frames}/faithful_udist_01_result.png" \
  -loop 1 -framerate 30 -t 2.65 -i "${frames}/faithful_udist_02_rstudio.png" \
  -loop 1 -framerate 30 -t 3.70 -i "${frames}/faithful_udist_03_data.png" \
  -loop 1 -framerate 30 -t 4.60 -i "${frames}/faithful_udist_04_fit.png" \
  -loop 1 -framerate 30 -t 5.10 -i "${frames}/faithful_udist_05_viewer.png" \
  -loop 1 -framerate 30 -t 3.00 -i "${frames}/faithful_udist_06_return.png" \
  -loop 1 -framerate 30 -t 3.60 -i "${frames}/faithful_udist_07_outro.png" \
