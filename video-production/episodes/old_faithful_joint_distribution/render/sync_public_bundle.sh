...
public_root="${gallery_root}/www/videos/old_faithful_joint_distribution"
...
destinations=(
  "${public_root}/old_faithful_joint_distribution.R"
  "${public_root}/old_faithful_joint_distribution.en.vtt"
  "${public_root}/old_faithful_joint_distribution.mp4"
  "${public_root}/old_faithful_joint_distribution_poster.png"
  "${public_root}/old_faithful_joint_distribution_transcript.txt"
)
