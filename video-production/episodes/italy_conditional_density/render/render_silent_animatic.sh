...
ffmpeg -hide_banner -y \
  -loop 1 -framerate 30 -t 2.85 -i "${frames}/italy_cdens_01_result.png" \
  -loop 1 -framerate 30 -t 2.35 -i "${frames}/italy_cdens_02_rstudio_context.png" \
  -loop 1 -framerate 30 -t 3.85 -i "${frames}/italy_cdens_03_ordered_year.png" \
  -loop 1 -framerate 30 -t 4.35 -i "${frames}/italy_cdens_04_fit.png" \
  -loop 1 -framerate 30 -t 3.35 -i "${frames}/italy_cdens_05_summary.png" \
  -loop 1 -framerate 30 -t 4.55 -i "${frames}/italy_cdens_06_plot.png" \
  -loop 1 -framerate 30 -t 2.65 -i "${frames}/italy_cdens_07_rstudio_return.png" \
  -loop 1 -framerate 30 -t 3.50 -i "${frames}/italy_cdens_08_outro.png" \
