...
public_root="${gallery_root}/www/videos/old_faithful_automatic_local_polynomial"
...
destinations=(
  "${public_root}/old_faithful_automatic_local_polynomial.R"
  "${public_root}/old_faithful_automatic_local_polynomial.en.vtt"
  "${public_root}/old_faithful_automatic_local_polynomial.mp4"
  "${public_root}/old_faithful_automatic_local_polynomial_poster.png"
  "${public_root}/old_faithful_automatic_local_polynomial_transcript.txt"
)
