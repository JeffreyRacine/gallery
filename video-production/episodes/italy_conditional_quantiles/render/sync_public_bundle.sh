...
public_root="${gallery_root}/www/videos/italy_conditional_quantiles"
...
destinations=(
  "${public_root}/italy_conditional_quantiles.R"
  "${public_root}/italy_conditional_quantiles.en.vtt"
  "${public_root}/italy_conditional_quantiles.mp4"
  "${public_root}/italy_conditional_quantiles_poster.png"
  "${public_root}/italy_conditional_quantiles_transcript.txt"
)
