...
public_root="${gallery_root}/www/videos/italy_ordered_numeric_gradients"
...
destinations=(
  "${public_root}/italy_ordered_numeric_gradients.R"
  "${public_root}/italy_ordered_numeric_gradients.en.vtt"
  "${public_root}/italy_ordered_numeric_gradients.mp4"
  "${public_root}/italy_ordered_numeric_gradients_poster.png"
  "${public_root}/italy_ordered_numeric_gradients_transcript.txt"
)
