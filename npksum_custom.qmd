...
In 0.70-5, numeric `bws` input is also materialized against the supplied data
before dispatch. This matters for custom mixed-data calculations: continuous,
unordered, and ordered columns retain their data-aware kernel types rather than
being treated as a default all-continuous bandwidth object.
